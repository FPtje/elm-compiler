...
typeOfGroup eqgroup
    ...
    where
        ...
        recordEvidence = [(c1Id, c2Id) | (c1Id, (BS.VCon "1Record" [ev1, _], _)) <- allConstants, (c2Id, (BS.VCon "1Record" [ev2, _], _)) <- allConstants, c1Id < c2Id, not $ BS.matchConsEvidence ev1 ev2]
